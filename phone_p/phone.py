...
conn = mysql.connector.connect(user='root', password='Pranav#77', host='localhost', database="phonepe_pulse")
...
if SELECT == "Basic insights":
    ...
    if select=="Top 10 states based on year and amount of transaction":
        ...
        cursor.execute("SELECT DISTINCT States, District, SUM(RegisteredUsers) AS Users FROM top_user GROUP BY States, District ORDER BY Users DESC LIMIT 10");
...
if SELECT == "Home":
    col1,col2, = st.columns(2)
    col1.image(Image.open("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\phonepe.png"),width = 500)
    with col1:
    ...
    with col2:
        st.video("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\upi.mp4")
    ...
    Data_Aggregated_Transaction_df= pd.read_csv(r'C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Aggregated_Transaction_Table.csv')
    Data_Aggregated_User_Summary_df= pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Aggregated_Transaction_Table.csv")
    Data_Aggregated_User_df= pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Aggregated_Transaction_Table.csv")
    Scatter_Geo_Dataset =  pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_Districts_Longitude_Latitude.csv")
    Coropleth_Dataset =  pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_IndiaStates_TU.csv")
    Data_Map_Transaction_df = pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_Transaction_Table.csv")
    Data_Map_User_Table= pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_User_Table.csv")
    Indian_States= pd.read_csv(r"C:\Users\91888\Desktop\Phonepe_project\Phonepe_Pulse_Data_Visualization\myfolder\Longitude_Latitude_State_Table.csv")
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\pulse-video.mp4")
    with col2:
        st.image(Image.open("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\PhonePe_Logo.jpg"),width = 500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\top.jpeg"),width = 400)
        with open("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\annual report.pdf","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:\\Users\\91888\\Desktop\\Phonepe_project\\Phonepe_Pulse_Data_Visualization\\myfolder\\report.jpeg"),width = 800)
...
if SELECT == "Contact":
    ...
    with col1:
        ...
        st.write("[LinkedIn](https://www.linkedin.com/in/pranav-bhawane-a9135817a)")
